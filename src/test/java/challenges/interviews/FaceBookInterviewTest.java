...
//        public Node copy() {
//
        public Node copyByDoga(int key){
            Node copy=new Node(key);
            if(this.right!=null){
...
//
public void inOrderTraversalByDoga() {
            if(left!=null){
                left.inOrderTraversalByDoga();
            }
    System.out.println(key);
            if(right!=null){
                right.inOrderTraversalByDoga();
            }
