...
public class ArraysAndStringsTest {
    ...
    public void PermutationOfTheOther() {
        ...
        Assert.assertTrue(permDetector.isPermutation("cba", "bca"));
    ...
    public void OneAway() {
        ...
        /*Assert.assertFalse(oneAwayDetector.oneAway("pale", "paleXX"));
        
        Assert.assertTrue(oneAwayDetector.oneAway("pale", "ple"));*/
        Assert.assertTrue(oneAwayDetector.oneAway("pxale", "pale"));
