...
public class   ClassicsTest {
    ...
    public void HarmlessRansomNote() {
        ...
        Assert.assertTrue(ransomNote.canWriteByDoga("Pay", "yaP"));
        Assert.assertTrue(ransomNote.canWrite("Pay", "yaP a"));
        Assert.assertTrue(ransomNote.canWriteByDoga(" Pay me $1000", "ayPem0001$"));
    ...
    public void SieveOfEratosthenes() {
        ...
        sieveOfEratosthenes.printByDoga(30);
    }
