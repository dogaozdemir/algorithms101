...
public class DynamicArray<String> {
   ...
   public boolean isEmpty() {
    ...
    /*public boolean Contains(String value) {
        return Arrays.stream(data).anyMatch(value::equals);
    }*/
  ...
  /*  public void delete(int index) {
        // Copy down
        for (int j = index; j < size - 1; j++) { //indexten başlat cunki öncesi sabit,bir eleman cikacagi icin size-1
            data[j] = data[j + 1]; //indexe kadar olanlar sabit kalsın. sonra gelenleri üzerine ve bir sonrakine yazırarak devam et.
        }
