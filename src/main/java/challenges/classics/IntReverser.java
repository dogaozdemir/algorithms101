...
public class IntReverser {
    ...
    public int reverse(int x) {
        ...
        while (x >= 1) {
            lastDigit = x % 10; // gives you last digit //her zaman son sayiyi verir
            reverse = reverse * 10 + lastDigit; //gelen rakami saga ekle
            x = x / 10; // get rid of last digit //sondaki rakamdan kurtul
        }
    ...
    public int reverseByDoga(int x) {
